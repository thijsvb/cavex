...
public class cavex extends PApplet {
...
public float realAngleBetween(PVector a, PVector b) {
...
public void showGuide() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cavex" };
    if (passedArgs != null) {
